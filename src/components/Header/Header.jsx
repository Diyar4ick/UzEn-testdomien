      ...
      <div className="header__promo">
        <div className="container">
          ...
          <div className="header__promo-lng">
            ...
            {openLng ? (
              <ul className={`header__promo-lng-list ${openLng ? "open" : ""}`}>
                <li>
                  <button
                    className="header__promo-lng-item"
      ...
      <div className="header__nav">
        <div className="container">
          ...
          <ul className={`header__nav-list ${burger ? "active" : ""}`}>
            ...
            >
              ...
              {activeMenu === "about" && (
                <ul className="header__nav-dropdown">
                  <li>
                    <NavLink to="/">Об организации </NavLink>
                  </li>
                  <li>
                    <NavLink to="/history">История</NavLink>
                  </li>
                  <li>
                    <NavLink to="/structure">Структура общества</NavLink>
                  </li>
                  <li>
                    <NavLink to="/management">Руководство</NavLink>
                  </li>
                  <li>
                    <NavLink to="/vacancies">Вакансии</NavLink>
                  </li>
                  <li>
                    <NavLink to="/public-events">
                      Публичные мероприятия, организованные обществом
                    </NavLink>
                  </li>
                </ul>
              )}
            ...
            <li
              className="header__nav-item"
              onClick={() => toggleMenu("corpotation")}
            >
              <button type="submit">Деятельность ▾</button>
              {activeMenu === "corpotation" && (
                <ul className="header__nav-dropdown">
                  <li>
                    <NavLink to="/activity">Услуги </NavLink>
                  </li>
                  <li>
                    <NavLink to="/projects">Проекты </NavLink>
                  </li>
                  <li>
                    <NavLink to="/tenders">Конкурсы и закупки </NavLink>
                  </li>
                </ul>
              )}
            </li>
            <li className="header__nav-item" onClick={() => toggleMenu("law")}>
              ...
              {activeMenu === "law" && (
                <ul className="header__nav-dropdown">
                  ...
                  <li>
                    <NavLink to="/exp">Опыт и компетенции </NavLink>
                  </li>
                  <li>
                    <NavLink to="/corp-manage">
                      Корпоративное управление
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/significant-facts">
                      Существенные факты
                    </NavLink>
                  </li>
                  <li>
                  ...
                  <li>
                    <NavLink to="/FXD-table">Сравнительная таблица ФХД</NavLink>
                  </li>
                  <li>
                    <NavLink to="/faces">Список аффилированных лиц</NavLink>
                  </li>
                  <li>
                    <NavLink to="/stratagy">
                  ...
                  <li>
                    <NavLink to="/prospect">Проспект эмиссии </NavLink>
                  </li>
                  <li>
                    <NavLink to="/autdit-conclusion">
                      АУДИТОРСКИЕ ЗАКЛЮЧЕНИЯ МСФО{" "}
                    </NavLink>
                  </li>
                  <p> - АКЦИОНЕРАМ</p>
                  <li>
                    <NavLink to="/divident-info">
                      Информация о дивидендах{" "}
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/business-plan-doing">
                      Выполнение бизнес плана{" "}
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/voting-results">
                      Итоги голосования ОСА{" "}
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="/budget-distribution">
            ...
            >
              ...
              {activeMenu === "service" && (
                <ul className="header__nav-dropdown">
                  <li>
                    <NavLink to="/adv">Почему выбирают нас </NavLink>
                  </li>
                </ul>
              )}
            </li>
